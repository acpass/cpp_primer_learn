...
int (*func_retfunc())(int) { return func; }

using func_alias = decltype(func); // func_alias is a function type

func_alias *
func_retfunc2() // should write the return type of func pointer explicitly
{
  return func;
}

using func_pointer = decltype(func)
    *; // decltype return a function type instead of a pointer to function type
